...
final class OptionCell: UICollectionViewCell {
    ...
    func configure(rows: [(String, [String])]) {
        ...
        rows.forEach { (option, items) in
            let optionView = OptionView()
            optionView.configure(option: option, items: items)
...
extension OptionCell {
    final class OptionView: UIView {
        ...
        func configure(option: String, items: [String]) {
            optionLabel.text = option
            segmentControl.configure(items: items)
        }
...
extension OptionCell {
    final class SettingSegmentedControl: UISegmentedControl {
        ...
        func configure(items: [String]) {
            ...
            let totalWidth = Metric.itemWidth * CGFloat(items.count)
